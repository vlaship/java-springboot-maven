...
public class StoreService {
  ...
  @NonNull
  @Transactional
  public StoreResponse create(@NonNull CreateStoreRequest dto) {
  ...
  @NonNull
  @Transactional
  public StoreResponse update(@NonNull Long id, @NonNull UpdateStoreRequest dto) {
  ...
  @NonNull
  @Transactional(readOnly = true)
  public StoreResponse findById(@NonNull Long id) {
